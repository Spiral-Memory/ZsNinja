...
function changeImg() {
    headerEl.style.backgroundImage = ` linear-gradient(rgba(0, 0, 0, 0.664),rgb(0, 0, 0)), url(images/${images[i]}.jpg)`;
...
ticEl[i].addEventListener('click',function(){
   ...
   modelLink.href = "tic-tac-game/tic.html"
...
guessEl[i].addEventListener('click',function(){
    ...
    modelLink.href = "guess-game/guess.html"
...
for (let i = 0; i < diceEl.length; i++) {
 diceEl[i].addEventListener('click',function(){
    ...
    modelLink.href = "dice-game/pig.html"
